...
<img src="/assets/images/data-availability/gif-programiz.gif" style ="width: 100%;">
...
I was planning to make <a href ="https://github.com/Rhitabrat/covid-19-cases-nepal"></a>bar chart race</a> animation showing the number of active COVID cases in each province. So, I found <a href ="https://drive.google.com/drive/folders/1QhLMbT76t6Zu1sFy5qlB5aoDbHVAcnHx">an official repository</a> of the data. In the early reports, the data were represented in pdf format as in the figure below.
<img src="/assets/images/data-availability/covid-case-1.png" style ="width: 100%;">
...
<img src="/assets/images/data-availability/covid-case-2.png" style ="width: 100%;">
